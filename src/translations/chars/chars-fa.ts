...
const mafias = [
  ...
  },
  {
    ...
    title: "بمب ساز",
    description:
      "یک روز در طول بازی تا قبل از پایان مرحله اول رای گیری با اعلام کلمه بمب ساز بلند می شود. و با نزدیک شدن به یک نفر، او را بصورت انتحاری همراه با خود از بازی خارج می کند.در سناریو زودیاک بمب ساز می تواند یک بار در بازی یک بمب روی یک نفر بگذارد چه شهروند چه مافیا و چه مستقل و یک عدد از 1 تا 4 به گرداننده بگوید و فردای آن روز بمب فقط با آن عدد خنثی می شود.",
    max: 1,
    type: "mafia",
  },
  {
...
const updates = [
  ...
  },
  {
    ...
    title: "اوشن",
    description:
      "در طول بازی دو شب می تواند یک شهروند را بیدار کند و با او آشنا شود البته حق ندارند از قابلیت های همدیگر صحبت کنند.در صورتی که اوشن زودیاک و یا مافیا را بیدار کند فردا خودش از بازی خارج می شود.",
    max: 1,
    type: "citizen",
  },
  {
    ...
    title: "زودیاک",
    description:
      "یک قانل سریالی است که نه شهروند است و نه مافیا مستقلی است که شب های زوج به یک نفر تیر می زند البته باید مواظب باشد به محافظ بازی تیر نزند چون خودش از بازی بیرون می رود.در صورت گفتن استعلام وضعیت توسط گرداننده اگر زودیاک در بازی نباشد اعلام می شود که قاتل زنجیره ای بیرون است.هیچ شلیک شبی روی او اثر ندارد.اگر در طول روز تیر بخورد از بازی خارج می شود.اگر بمب روی او باشد نیز اگر خنثی نکند از بازی خارج می شود.زودیاک با رای گیری نیز از بازی خارج می شود.",
    max: 1,
    type: "independent",
  },
  {
